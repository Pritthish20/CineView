...
movieRoute.post('/create-movie',authenticate,authenticateAsAdmin,createMovie)
movieRoute.put('/update-movie/:id',authenticate,authenticateAsAdmin,updateMovie)
movieRoute.delete('/delete-movie/:id',authenticate,authenticateAsAdmin,deleteMovie);
movieRoute.delete('/delete-comment',authenticate,authenticateAsAdmin,deleteComment);
